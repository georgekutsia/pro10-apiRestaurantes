...
const comidasSchema = new Schema(
      {
        ...
        dietaryPreferences: { type: String, required: false, enum: ['Vegano', 'Vegetariano', 'Carnívoro', 'Halal', 'Kosher','Paleo', 'Sugar-free', 'Low-sodium', 'Pescatarian'], trim: true},
        allergen: [{type:String, required:false, trim:true}],
